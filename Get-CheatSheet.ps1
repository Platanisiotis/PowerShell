...
function Get-CheatSheet
{
    ...
    switch ($Reference) 
    {
        Operators 
        {
            ...
            {
                $Properties = [ordered]@{"Operator"= $Stat[0];
                                "Description"= $Stat[1];
                                "Example"= $Stat[2];
                                "Result"= $Stat[3];
                }
        ...
        'Parameter Attribute Property'
        {
            ...
            foreach ($Stat in $CollectionStats)
            {
                $Properties = [ordered]@{"Parameter Attribute Property"= $Stat[0];
                                "Example"= $Stat[1];
                                "Meaning"= $Stat[2];
                }
                $Object += New-Object -TypeName PSObject -Property $Properties
        ...
        'Default Variables'
        {
            ...
            foreach ($Stat in $CollectionStats)
            {
                $Properties = [ordered]@{"Variable"= $Stat[0];
                                "Description"= $Stat[1]
                }
                $Object += New-Object -TypeName PSObject -Property $Properties
            }
        ...
        'ADS Constants'
        {
            ...
            foreach ($Stat in $CollectionStats)
            {
                $Properties = [ordered]@{"ADS constant"= $Stat[0];
        ...
        'Debugging Commands'
        {
            ...
            foreach ($Stat in $CollectionStats)
            {
                $Properties = [ordered]@{"Keyboard Shortcut"= $Stat[0];
                                "Name"= $Stat[1];
                                "Meaning"=$Stat[2]
                }
                $Object += New-Object -TypeName PSObject -Property $Properties
        ...
        'UTF-8 Unicode'
        {
            ...
            foreach ($Stat in $CollectionStats)
            {
                $Properties = [ordered]@{"Name"= $Stat[3];
                                "Character"= $Stat[1];
